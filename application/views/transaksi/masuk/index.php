...
<form class="form-horizontal" action="<?php echo base_url() ?>Masuk/insert_masuk" method="post" enctype="multipart/form-data">
  <div class="row">
   <div class="col-md-12">
    <div class="box-body">
      <div class="panel panel-default">
       <div class="panel-heading">Data Masuk</div>
       <div class="box-body">
        <div class="form-group" style="padding-bottom: 5px;">
          <div class="col-xs-2">
            <label for="id_masuk">No Masuk</label>
            <input type="text" name="id_masuk" readonly class="form-control" value="<?php echo $hasilkode; ?>"/>
          </div>
          <div class="col-xs-2">
            <label for="tgl_transaksi">Tanggal Masuk</label>
            <input type="text" name="tgl_masuk" readonly class="form-control" value="<?php echo date('d-F-Y h:i') ?>"/>
          </div>
          <div class="col-xs-2">
...
<div class="row">
 <div class="col-md-12">
  <div class="panel panel-default">
   <div class="panel-heading">Form Input Barang Masuk</div>
   <div class="box-body">
    <div class="box-body">
      ...
      <div class="box-body">
        <table class="display table table-bordered table-hover">
          ...
          <tbody>
            ...
            <form name="fform" method="post" action="<?php echo base_url() ?>Masuk/delete_detail">
              ...
              <input type="hidden" name="jumlah_masuk" value="<?php echo $value->jumlah_masuk; ?>">
              <tr>  
                <td><?php echo $no; ?></td>
                <td><?php echo $value->nama_barang ?></td>
                <td>Rp.<?php echo number_format($value->harga_beli) ?></td>
                <td><?php echo $value->jumlah_masuk ?> Pcs</td>
                <td>Rp.<?php echo number_format($value->harga_beli * $value->jumlah_masuk) ?></td>
                <td align="center">
              ...
              <?php
              $total_bayar = $total_bayar + ($value->harga_beli * $value->jumlah_masuk);
              $no++;
            } ?>
          </tbody>
          <tfoot>
        ...
        <form action="<?php echo base_url() ?>Masuk/insert_masuk_final" method="POST">
          <input type="hidden" name="id_masuk" value="<?php echo $hasilkode; ?>">
          <input type="hidden" name="id_user" value="<?php echo $this->session->userdata('id_user') ?>">
          <input type="hidden" name="total_bayar" value="<?php echo $total_bayar; ?>">
          <div class="form-group">
            <label class="col-sm-1 control-label"></label>
            <div class="col-sm-3" align="left">
              <a href="<?php echo base_url() ?>Masuk/batal_transaksi/<?php echo $total_bayar; ?>"><button type="button" name="batal" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-times"> BATAL</i></button></a>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    sum();
    $("#harga_beli, #jumlah_masuk").on("keydown keyup", function() {
      sum();
    });
  });
  ...
  function sum() {
    ...
    var num2 = document.getElementById('jumlah_masuk').value;
