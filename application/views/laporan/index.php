...
<form class="form-horizontal" action="<?php echo base_url() ?>Laporan/laporan_penjualan_detail" method="post" enctype="multipart/form-data">
 <div class="col-md-6">
  <div class="box-body">
    <div class="panel panel-default">
     <div class="panel-heading">Laporan Penjualan Detail</div>
     <div class="box-body">
      <div class="form-group">
        <div class="col-md-3">
          <label for="dari">Dari</label>
