  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Master Data Suplier</h3>
        </div>  
       ...
       <?php } ?>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-xs-12">
              <button class="btn btn-primary pull-right" onclick="add_Suplier()"><span class="fa fa-plus"></span> Tambah Master Suplier</button>
            </div>
          </div>
          <br>
    ...
    $(document).ready(function() { //TAMPIL DATA TABLE SERVER SIDE
      table = $('#table').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo site_url('Suplier/list_data')?>",
          "type": "POST"
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
        url = "<?php echo site_url('Suplier/ajax_add')?>";
      }
      else
      {
        url = "<?php echo site_url('Suplier/ajax_update')?>";
      }
     ...
     function edit_Suplier(id)
     {
      ...
      $.ajax({
        url : "<?php echo site_url('Suplier/ajax_get_Suplier_by_id')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          ...
          $('.modal-title').text('Update Form Master Suplier'); // Set title to Bootstrap modal title
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <h3 class="modal-title">Master Suplier Form Input</h3>
        </div>
        <form action="#" id="form">
